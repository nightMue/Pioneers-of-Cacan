...
Public Class ServerGUI
      ...
      Sub()
         ...
         While Not gameStart And numOfPlayers < 4
            Try
               ...
               Dim player As Player1 = New Player1(client, numOfPlayers)
   ...
   Private Sub btnGameStart_Click(sender As Object, e As EventArgs) Handles btnGameStart.Click
      Dim cl = Player1.clients.First
      Dim p = New Player("Player One", Color.Blue, 1)
      p.startGame()
      Me.Hide()
   End Sub
End Class
